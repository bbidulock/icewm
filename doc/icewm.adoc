...
ClickToFocus = 1:: Enables click to focus mode.  RaiseOnFocus = 1:: Window is raised when focused.  FocusOnClickClient = 1:: Window is focused when client area is clicked.
