...
YIcon::Image * YIcon::loadIcon(int size) {
...
YIcon::Image * YIcon::huge() {
	...
	if (fHuge == NULL && (fHuge = large()))
	    fHuge = new Image(*fHuge, hugeSize(), hugeSize());
...
YIcon::Image * YIcon::large() {
	...
	if (fLarge == NULL && (fLarge = huge()))
	    fLarge = new Image(*fLarge, largeSize(), largeSize());
...
YIcon::Image * YIcon::small() {
	...
	if (fSmall == NULL && (fSmall = large()))
	    fSmall = new Image(*fSmall, smallSize(), smallSize());
