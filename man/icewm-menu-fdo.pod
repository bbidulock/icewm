...
Don't print the C<Other> category, only official categories.
...
submenus and move this one to the parent submenu. Limitations: this
looks only one level below, multiple moving is not supported yet.
