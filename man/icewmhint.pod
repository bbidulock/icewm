...
General option arguments are normally associated with I<GNOME WinWM/WMH>
...
The layer is a similar concept to the layer specified by I<GNOME/WMH> and
implied by I<NetWM/EWMH>.  It is in this case however specific to
L<icewm(1)>.
