...
Do not add an icon to the tray pane.
The window button only appears on the task pane.

=item B<Minimized> (1)

Add an icon to the tray pane.  Remove the task pane button when
minimized.
The window has its icon on the tray pane and when it is not minimized it
has also a window button on the task pane.  There is no window button on
the task pane when the window is minimized.

=item B<Exclusive> (2)

Add an icon to the tray pane.  Never create a task pane button.
The window has only its icon on the tray pane and there is no window
button on the task pane.
