...
In this case, if I<FILE> starts with an
exclamation mark then the images from
this directory are permuted randomly.
Image file names or directory names may have
wildcards, see L<glob(7)>, which will be expanded.
