...
arguments apply. If none is given, but an argument does require a
window, a selection crossbar is invoked to select the desired window
interactively. Some arguments do not require this.
...
Selects clients with a WM_CLIENT_MACHINE property equal to I<HOST>.
