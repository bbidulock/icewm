...
B<icesh> provides 69 commands to change or query a window's state,
...
be C<All> for all monitors or C<this> for the monitor where the
active window is displayed.
