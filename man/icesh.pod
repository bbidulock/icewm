...
The window must have a I<_NET_WM_ICON> property.
...
=item B<getWorkspaceName> I<INDEX>

Print the name of workspace I<INDEX>, where I<INDEX> is
a workspace number starting from zero.

=item B<getWorkspaceNames>
...
has a WM_WINDOW_ROLE value of C<special> or start it with B<runonce>.
