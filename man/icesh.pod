...
B<icesh> provides 76 commands to change or query a window's state,
...
Filters clients by window gravity. Clients with a window gravity equal
to I<GRAVITY> are selected. If I<GRAVITY> starts with an exclamation
