...
From the file F<env> in the user configuration directory
...
If there exists an executable script F<startup> in the user configuration
...
a F<shutdown> script, if it exists in the user configuration directory.
