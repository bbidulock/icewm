...
=item B<icewm-menu-gnome2> [I<OPTIONS>]

=item B<icewm-menu-gnome2> {B<-h>|B<--help>} [I<OPTIONS>]

=item B<icewm-menu-gnome2> {B<-V>|B<--version>}

=item B<icewm-menu-gnome2> {B<-C>|B<--copying>}
