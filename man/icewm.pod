...
C<KeySysSwitchNext> opens the C<QuickSwitch> popup (see L<INPUT FOCUS>) and/or moves the selector.

=item C<Alt+Shift+Tab>

C<KeySysSwitchLast> works like C<KeySysSwitchNext> but moving in the opposite direction.
