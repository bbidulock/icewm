...
preferred keyboard layouts:

 KeyboardLayouts="de","fr","jp"

A keyboard layout can be a two-letter keyboard layout name, but if
it is enclosed in double quotes, it can be a space-separated list of
...
this configured keyboard layout. The task bar will show this.
