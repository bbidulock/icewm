...
F<> F<$ICEWM_PRIVCFG/menu>
 F<$XDG_CONFIG_HOME/icewm/menu>
 F<$HOME/.icewm/menu>
 F</etc/icewm/menu>
...
=item F<$ICEWM_PRIVCFG/menu>

=item F<$XDG_CONFIG_HOME/icewm/menu>

=item F<$HOME/.icewm/menu>

=item F</etc/icewm/menu>

=item F</usr/share/icewm/menu>
