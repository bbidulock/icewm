...
F<> F<$ICEWM_PRIVCFG/programs>
 F<$XDG_CONFIG_HOME/icewm/programs>
 F<$HOME/.icewm/programs>
 F</etc/icewm/programs>
 F</usr/share/icewm/programs>

=head1 DESCRIPTION

The F<menu> file is responsible for configuring most of the generated
items in the L<icewm(1)> root menu and start menu, and is normally
included in those menus using the B<menufile> keyword.
...
=item B<menufile> [B<">]I<title>[B<">] I<icon> I<filename>, B<separator>
...
=item F<$ICEWM_PRIVCFG/programs>

=item F<$XDG_CONFIG_HOME/icewm/programs>

=item F<$HOME/.icewm/programs>

=item F</etc/icewm/programs>

=item F</usr/share/icewm/programs>
